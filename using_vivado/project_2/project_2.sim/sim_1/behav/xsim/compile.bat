...
REM
REM Generated by Vivado on Fri Apr 17 17:10:46 +0200 2026
...
echo "xvhdl --incr --relax -prj w14_st24_tb_vhdl.prj"
call xvhdl  --incr --relax -prj w14_st24_tb_vhdl.prj -log xvhdl.log
