...
HD_PWD='C:/HOME/github/vhd code github/VHDL_codes/using_vivado/uart_communication/uart_communication.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart2.tcl
