...
REM
REM Generated by Vivado on Sat Apr 18 18:23:26 +0200 2026
...
echo "xvhdl --incr --relax -prj uart2_tb_vhdl.prj"
call xvhdl  --incr --relax -prj uart2_tb_vhdl.prj -log xvhdl.log
