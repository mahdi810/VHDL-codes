...
REM
REM Generated by Vivado on Fri Apr 17 10:36:34 +0200 2026
...
echo "xvhdl --incr --relax -prj w14_st2_bhv_tb_vhdl.prj"
call xvhdl  --incr --relax -prj w14_st2_bhv_tb_vhdl.prj -log xvhdl.log
