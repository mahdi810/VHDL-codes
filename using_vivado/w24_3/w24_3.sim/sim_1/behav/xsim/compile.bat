...
REM
REM Generated by Vivado on Sat Apr 18 21:02:59 +0200 2026
...
echo "xvhdl --incr --relax -prj w24_3_tb_vhdl.prj"
call xvhdl  --incr --relax -prj w24_3_tb_vhdl.prj -log xvhdl.log
