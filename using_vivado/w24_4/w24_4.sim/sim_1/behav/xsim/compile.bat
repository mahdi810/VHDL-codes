...
REM
REM Generated by Vivado on Sat Apr 18 22:06:43 +0200 2026
...
echo "xvhdl --incr --relax -prj w24_4_tb_vhdl.prj"
call xvhdl  --incr --relax -prj w24_4_tb_vhdl.prj -log xvhdl.log
